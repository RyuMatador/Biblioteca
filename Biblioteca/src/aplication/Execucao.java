...
public class Execucao {
	...
	public static void main(String[] args) {
		...
		while (choose.equalsIgnoreCase("n") == false) {
			...
			try {
				...
				System.out.println("Caracter indevido. Insira uma das opções do menu: ");
			} 
		}
	...
	public static void readOption() {
		// É preciso instanciar um scanner novo para que o bloco try catch não entre em looping por causa do valor que o option recebe do scanner in.
